...
(function () {
    ...
    var EN = {
        ...
        "• Nové a upravené výkresy vrátane fotiek a nástroje sa prestanú odosielať na server.": "• New and edited drawings including photos, and tools, will no longer be sent to the server.",
        "• To, čo už je v cloude, tam zostane. Ak nechcete mať na serveri nič, zapnite tento režim ešte pred pridaním prvého výkresu.": "• Whatever is already in the cloud stays there. If you want nothing on the server, turn this mode on before adding your first drawing.",
        ...
        "Fotky sa nahrajú neskôr, keď bude internet": "Photos will upload later when there's internet",
        "Niektoré fotky sú uložené len v tomto zariadení a ešte sa nenahrali do cloudu. Pripojte sa na internet, počkajte, kým sa nahrajú, a skúste znova.": "Some photos are stored on this device only and haven't been uploaded to the cloud yet. Connect to the internet, wait until they upload and try again.",
